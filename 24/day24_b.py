  ...
  for combination in combinations(all_weights, tam1):
    ...
    for tam2 in range(1, len(all_weights_minus_used_in_group_1)-1):
      for combination2 in combinations(all_weights_minus_used_in_group_1, tam2):
        ...
        all_weights_minus_used_in_g1_g2 = [x for x in all_weights_minus_used_in_group_1 if x not in combination2]

        for tam3 in range(1, len(all_weights_minus_used_in_g1_g2)-1):
          for combination3 in combinations(all_weights_minus_used_in_g1_g2, tam3):
            if sum(combination3) != group_weight:
              continue
